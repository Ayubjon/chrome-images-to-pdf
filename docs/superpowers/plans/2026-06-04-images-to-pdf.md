...
**Соглашения:**
- Все коммиты в конце сообщения содержат строку `Co-Authored-By: Claude Opus 4.8 <noreply@anthropic.com>` (в шагах для краткости показан только заголовок коммита).
